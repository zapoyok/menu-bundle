 ...
 * NodeInterface.
 */
class MenuNode implements NodeInterface, MenuNodeInterface
{
    /**
     ...
     * Set parent.
     *
     * @param MenuNodeInterface $parent
     *
    ...
    public function getNameWithLevel($sep = '—')
    {
        return str_repeat($sep, $this->getLevel()) . ' ' . $this->getName();
    }
}
